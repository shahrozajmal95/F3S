...
def get_save_path(args):
    if args.backbone =="vgg":
        ...
        backbone_str = 'regnet'
    elif args.backbone == "mobilvitv2":
        backbone_str = 'mobilevitv2'
...
def scoremap2bbox(scoremap, threshold, multi_contour_eval=False):
    ...
    # img_contours = cv2.drawContours(thr_gray_heatmap, contours, -1, (255, 0, 0), 5)   #Draw outline
    ...
    for contour in contours:
        x, y, w, h = cv2.boundingRect(contour)   # down left coordinates and width and height
